...
const Footer = forwardRef(function Footer(props, ref){
    ...
    const sendEmail = (e) => {
        ...
        if(name === '' || email === '' || message === ''){
            ...
            emailjs.sendForm('service_zdd8s44', 'contact_form', form.current, 'AITX31GXbwk0VKe5g')
                .then((result) => {
            ...
            >
                ...
                <div className="app__footer-cards">
                    <div className="app__footer-card">
                        ...
                        <a href="mailto:oladotunlaniyan@gmail.com" className='p-text'>oladotunlaniyan@gmail.com</a>
                    </div>
                    <div className="app__footer-card">
                        <img src={images.mobile} alt="mobile" />
                        <a href="tel: +2347039451271" className='p-text'>(+234) 70-3945-1271</a>
                    </div>
                </div>
                {!isFormSubmited
                    ? 
